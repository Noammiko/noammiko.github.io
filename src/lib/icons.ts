...
const icons = {
  ...
  instagram: { icon: "fa-brands:instagram", label: "Instagram" },
  spotify: { icon: "fa-brands:spotify", label: "Spotify" },
  tiktok: { icon: "fa-brands:tiktok", label: "TikTok" },
  youtube: { icon: "fa-brands:youtube", label: "YouTube" },
  youtubeMusic: { icon: "simple-icons:youtubemusic", label: "YouTube Music" },
