    ...
    >
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input required className={inputCls} placeholder="e.g. 2024 or 2024-09" value={form.date} onChange={set("date")} />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <label htmlFor="review-active" className="text-sm text-[rgba(245,240,232,0.7)] font-['Josefin_Sans']">
          Show on site
        </label>
      </div>
    ...
    <div className="space-y-6">
      <div className="border border-[rgba(255,193,7,0.12)] bg-[rgba(255,193,7,0.02)] px-4 py-3">
        ...
        <p className="text-xs text-[rgba(245,240,232,0.4)] font-['Josefin_Sans']">
          Reviews are served live from Convex — changes appear on the site instantly without a rebuild.
        </p>
      </div>
          ...
          {reviews.map((r) => (
            <div key={r._id}
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-[rgba(245,240,232,0.5)] font-['Josefin_Sans'] leading-relaxed line-clamp-2">
                  {r.text}
                </p>
              </div>
